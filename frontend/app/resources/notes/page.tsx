              ...
              <div className="flex gap-2 sm:gap-3 mb-6">
                <div className="flex-1 relative">
                  <Input
                    ...
                    className="w-full pl-8 sm:pl-10 pr-4 py-4 sm:py-6 text-sm sm:text-base bg-white border-2 border-gray-900 focus:ring-2 focus:ring-blue-500"
                  />
                  <svg 
                    className="absolute left-2 sm:left-3 top-1/2 -translate-y-1/2 w-4 h-4 sm:w-5 sm:h-5 text-gray-500"
                    fill="none" 
                    stroke="currentColor" 
                    viewBox="0 0 24 24"
                  >
                ...
                <Sheet>
                  <SheetTrigger asChild>
                    <Button className="lg:hidden bg-gray-900 hover:bg-gray-800 text-white px-4 sm:px-6 py-4 sm:py-6">
                    ...
                    <Card key={note.id} className="relative overflow-hidden border-2 border-gray-900 shadow-lg hover:shadow-xl transition-all group bg-gradient-to-br from-blue-50 to-indigo-50">
                      <div className="relative z-10 p-3 sm:p-4 md:p-6 flex flex-col h-full">
                        <div className="flex items-start justify-between mb-2 sm:mb-3">
                          <h3 className="text-sm sm:text-base md:text-lg font-bold text-gray-900 leading-tight pr-1 sm:pr-2 line-clamp-2">
                            {note.title}
                          </h3>
                          <FileText className="w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5 text-blue-600 flex-shrink-0 mt-0.5 sm:mt-1" />
                        </div>

                        <p className="text-[10px] sm:text-xs md:text-sm text-gray-600 mb-2 sm:mb-3 md:mb-4 line-clamp-2 flex-grow">
                          {note.description}
                        </p>

                        <div className="space-y-1 sm:space-y-1.5 md:space-y-2 mb-2 sm:mb-3 md:mb-4">
                          <div className="flex items-center gap-1 sm:gap-2">
                            <Badge className="bg-blue-600 text-white hover:bg-blue-700 font-medium px-1 sm:px-1.5 md:px-2 py-0.5 text-[9px] sm:text-[10px] md:text-xs truncate max-w-full">
                              <BookOpen className="w-2 h-2 sm:w-2.5 sm:h-2.5 md:w-3 md:h-3 mr-0.5 sm:mr-1 flex-shrink-0" />
                          ...
                          <div className="flex items-center justify-between text-[9px] sm:text-[10px] md:text-xs text-gray-600">
                            <div className="flex items-center">
                              <GraduationCap className="w-2.5 h-2.5 sm:w-3 sm:h-3 md:w-3.5 md:h-3.5 mr-0.5 sm:mr-1" />
                              <span className="font-medium">{note.level}</span>
                            </div>
                            <div className="flex items-center">
                              <Calendar className="w-2.5 h-2.5 sm:w-3 sm:h-3 md:w-3.5 md:h-3.5 mr-0.5 sm:mr-1" />
                        ...
                        <Button 
                          className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 sm:py-2.5 md:py-5 shadow-md text-xs sm:text-sm md:text-sm"
                          onClick={() => handleDownload(note)}
                        >
                          <Download className="w-3 h-3 sm:w-3.5 sm:h-3.5 md:w-4 md:h-4 mr-1.5 sm:mr-2 md:mr-2" />
                          Download
                        </Button>
                      </div>
                    </Card>
