      ...
      <footer className="bg-black text-white py-12 border-t border-gray-800" data-events-footer>
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8 mb-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:flex lg:gap-16 gap-8">
              {/* Services */}
              <div>
                <h3 className="text-white font-medium mb-4">Services</h3>
                <div className="space-y-2 text-sm text-gray-400">
                  <div>SDK development</div>
                  <div>& maintenance</div>
                  <div className="mt-3">Cross-platform</div>
                  <div>development</div>
                </div>
              </div>
          ...
          {/* Bottom Row */}
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between pt-8 border-t border-gray-800 gap-4">
            {/* Social Icons */}
            <div className="flex items-center space-x-4 order-2 lg:order-1">
              {/* X (Twitter) */}
